    ...
    $.validator.setDefaults({
        ...
        messages: {
            fullname: {
                ...
                regexName: i18n('form.regexName'),
                maxlength: i18n('form.maxLength')
            },
            email: {
